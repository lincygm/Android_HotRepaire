	 #include "com_lincy_back_Uninstall.h"
	  ...
	  static const char APP_DIR[] = "/data/data/com.lincy.back";
	  static const char APP_FILES_DIR[] = "/data/data/com.lincy.back/files";
	  static const char APP_OBSERVED_FILE[] = "/data/data/com.lincy.back/files/observedFile";
	  static const char APP_LOCK_FILE[] = "/data/data/com.lincy.back/files/lockFile";
	  /* ÄÚÈ«ŸÖ±äÁ¿ */
	   ...
	   * return:
	   */
	  JNIEXPORT int JNICALL Java_com_lincy_back_MainActivity_init(JNIEnv *env, jobject obj, jstring userSerial)
	  {
